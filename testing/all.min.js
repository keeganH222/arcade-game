...
function rand() {
  ...
  return function (won) {
    if (won) {
      counter += 5;
      var randNum = 10 + Math.floor(Math.random() * counter);
      return randNum;
    } else if (player.bugIntervals > 1400) {
      var _randNum = Math.floor(Math.random() * 20) + counter;

      bugSprint = false;
      return _randNum;
    } else {
      var _randNum2 = Math.floor(Math.random() * 8) + counter;
...
function () {
  ...
  _createClass(Player, [{
    ...
    value: function drawLive() {
      ...
      ctx.fillText(player.lives, 230, 680); //will not respond in game over, nothing gets displayed at the top
...
var player = new Player(202, 417);
var allEnemies = [new Enemy(-80, 50), new Enemy(-80, 145), new Enemy(-80, 235)];
var spawnBugs = setInterval(function () {
...
var Engine = function (global) {
  ...
  canvas.width = 505;
  canvas.height = 707;
  doc.querySelector('.insert').append(canvas);
  ...
  Resources.load(['images/stone-block.png', 'images/water-block.png', 'images/grass-block.png', 'images/enemy-bug.png', 'images/char-boy.png', 'images/Heart.png']);
